...
//    }
//
//    func encrypt(plaintext: Data, nonce: Data? = nil, encoder: Encoding.Type = RawEncoder.self) throws -> Data {
...
//    }
//
//    func decrypt(ciphertext: Data, nonce: Data? = nil, encoder: Encoding.Type = RawEncoder.self) throws -> Data {
